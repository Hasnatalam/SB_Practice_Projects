 ...
 * All right reserved. 
 */
package com.app.main.SpringCoreMavenProject-02.plugins.swagger;
...
public class SwaggerConfig {
	...
	public static String CONTROLLER_URL="com.app.main.SpringCoreMavenProject-02.controller";    //Swagger扫描的接口路径
